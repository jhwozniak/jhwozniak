...
Data model was arranged in a relational star-schema with a "Bid" class in a center. Other classes/models like "Listing", "Category", "Watchlist" or "Comment" communicate with the "Bid" and with each other  
